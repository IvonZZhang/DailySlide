              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    ...
                    TextSpan(text: '\n ◦ Vergeet niet om gelijktijdig de groene of de rode bolletjes te tellen. Deze zullen in een willekeurige \n      volgorde verschijnen in het midden van het scherm. Voor elke reeks zal aangegeven worden welke kleur \n      geteld moet worden.'),
                    TextSpan(text: '\n ◦ Nadien zal u gevraagd worden om aan te duiden hoeveel rode of groene bolletjes u heeft geteld, zoals op \n      het voorbeeld rechtsonder.'),
                  ],
                ),
              ),
            ),
